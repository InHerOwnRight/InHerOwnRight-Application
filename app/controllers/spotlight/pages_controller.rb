...
module Spotlight
  ...
  class PagesController < Spotlight::ApplicationController
    ...
    def create
      ...
      if @page.save
        # FIX FOR ArgumentError: Please use symbols for polymorphic route arguments."
        redirect_to [spotlight, @page.exhibit, page_collection_name.to_sym], notice: t(:'helpers.submit.page.created', model: @page.class.model_name.human.downcase)
      else
        render action: 'new'
      end
    end
