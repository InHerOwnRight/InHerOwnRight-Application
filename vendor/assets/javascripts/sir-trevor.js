...
/***/ function(module, exports, __webpack_require__) {
	...
	var BlockManager = function BlockManager(SirTrevor) {
	  ...
	  this.blocks = [];
	  this.blockCounts = {};
	  this.blockTypes = ["Heading", "Text", "List","Quote","Iframe", "Video", "Oembed", "Rule", "UploadedItems",
								       "Browse", "FeaturedPages", "SolrDocuments",  "SolrDocumentsCarousel", "SolrDocumentsEmbed",
